...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelpath', type=str, default='~/openpose-tf/openpose-tf/data/private/tf-openpose-models-2018-08-08/')
    parser.add_argument('--logpath', type=str, default='~/openpose-tf/openpose-tf/data/private/tf-openpose-log-2018-08-08/')
